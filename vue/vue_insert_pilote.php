	...
	<div class="card" style="margin: 28px;margin-right: 0;margin-left: 0;">
		<div class="card-body" style="margin: 3px;">
			...
			<form method="post" style="margin-bottom: 30px;">
				<div class="mb-3"><input class="form-control form-control-lg" type="text" name="nom" placeholder="  Nom du pilote "></div>
				<div class="mb-3"><input class="form-control form-control-lg" type="text" name="prenom" placeholder=" Prenom du pilote "></div>
				<div class="mb-3"><input class="form-control form-control-lg" type="email" name="email" placeholder=" Email du pilote "></div>
